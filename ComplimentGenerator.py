...
FILE_LOCATION_INSULTS = os.path.join(os.path.dirname(__file__), "../data/Compliments.txt")
vowels = ["a", "e", "i", "o", "u"]
fast_slow_options = ["fast", "slow", "f", "s"]

# Imports and formats the file.
def import_file():
...
# Generates the actual compliments based on the three available formats and randomly selected words.
def generate_compliment(all_the_words, max_num, fast_slow_b):
    ...
    if fast_slow_b == "slow" or fast_slow_b == "s":
        if choose == 1:
            text1 = "You are {} {} person. Just absolutely {} {} being.\n".format(article_one, first_insult, article_two, third_insult)
            text_printer(text1)
        elif choose == 2:
            text2 = "I am {} {} person. My life is {}.\n".format(article_one, first_insult, third_insult)
            text_printer(text2)
        elif choose == 3:
            third_insult = third_insult + "s"
            text3 = "Everyone is just {}. They are all just perfectly {} people.\n".format(first_insult, second_insult)
            text_printer(text3)

    else:
        if choose == 1:
            print("You are {} {} person. Just absolutely {} {} being.\n".format(article_one, first_insult, article_two, third_insult))
        elif choose == 2:
            print("I am {} {} person. My life is {}.\n".format(article_one, first_insult, third_insult))
        elif choose == 3:
            third_insult = third_insult + "s"
            print("Everyone is just {}. They are all just perfectly {} people.\n".format(first_insult, second_insult))
...
def is_it_a_number_dumbass(number_1):
    ...
    while not y_n:
        try:
            ...
            number_1 = input("How many compliments would you like?\n")
...
def main():
    ...
    repeat_times = input("How many compliments would you like?\n")
    ...
    if repeat_times == "inf" or repeat_times == "infinity" or repeat_times == "infinite":
        while True:
            generate_compliment(all_the_words, max_num, fast_slow)
    else:
